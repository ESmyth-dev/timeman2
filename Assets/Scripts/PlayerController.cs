...
public class PlayerController : MonoBehaviour
{
    ...
    void BlinkAbility()
    {
        ...
        {
            if (Physics.Raycast(transform.position + transform.up * 0.7f, blinkVector, out RaycastHit hit, blinkDistance, LayerMask.GetMask(new string[] {"LevelLineOfSight", "Level"})))
            {
